...
* Via replicated.io packaging for deployment to a single server/VM, or to multiple servers/VMs. See <<quickstart-server-installs.html,Quick Start for Server/VM installs>>.
