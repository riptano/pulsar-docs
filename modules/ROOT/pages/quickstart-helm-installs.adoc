...
You can install the Pulsar Pulsar Admin Console in your cluster by enabling it with this values setting:
...
By default, the Pulsar Admin Console has authentication disabled.
