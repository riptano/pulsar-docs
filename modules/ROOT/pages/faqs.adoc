...
DataStax Luna Streaming provide a pre-configured https://www.replicated.com/[Replicated kURL] package to install Luna Streaming on a single server/VM or multiple (4) servers/VMs. Example initial setup commands:
