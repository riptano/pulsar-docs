...
DataStax Luna Streaming 2.8.0 is based on its distribution of Apache Pulsar 2.8.0, plus features and additional enhancements from DataStax contributors. 
