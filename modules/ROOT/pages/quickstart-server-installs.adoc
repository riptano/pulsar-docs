...
This document explains xref:quickstart-server-installs.adoc#install[installation] of Luna Streaming for Bare Metal/VM with a Pulsar tarball. +
...
|Contains all components from lunastreaming-core as well as the  support Pulsar SQL
