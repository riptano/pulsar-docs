...
. Optionally, add the TLS hostname and certificate information. 
+
Or, skip the LTS setup and click Continue. If you don't enter TLS information, a self-signed certificate will be used. 
