...
* Via a simple Helm chart for an existing Kubernetes environment, making it possible to run Pulsar on a laptop or with a cloud provider. See <<quickstart-helm-installs.adoc,Quick Start for Helm Chart installs>>. 
