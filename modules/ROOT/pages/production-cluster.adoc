...
For an example set of production cluster values, check out the DataStax production-ready https://github.com/datastax/pulsar-helm-chart[Helm chart]. +
DataStax recommends the following resources:
