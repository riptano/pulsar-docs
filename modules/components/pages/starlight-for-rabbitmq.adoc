...
Starlight for RabbitMQ brings native RabbitMQ protocol support to Apache Pulsar by introducing a RabbitMQ protocol handler on Pulsar brokers or Pulsar proxies.
