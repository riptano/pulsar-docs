...
:product-repo-name: pulsar-docs
:product-repo-name-long: datastax/pulsar-docs
:product-repo-link: https://github.com/datastax/pulsar-docs.git
:product-branch-name: main
:docset-name: luna-streaming
:product-branch-link: https://github.com/datastax/pulsar-docs/tree/main
